...
const teacherBootstrapClientPath = resolve(process.cwd(), "lib", "teacher-bootstrap-client.ts");
const accountProfileClientPath = resolve(process.cwd(), "lib", "account-profile-client.ts");
