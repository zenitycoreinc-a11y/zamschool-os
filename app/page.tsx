...
const featureCards = [
  {
    ...
    description: "Enrollment, profiles, academic history, and performance tracking in one place.",
  },
  {
    icon: Users,
    title: "Teacher and Staff",
    description: "Role-aware access for teachers, admin teams, and school operations.",
  },
  {
    icon: CalendarCheck,
    title: "Attendance Tracking",
    description: "Fast daily roll call with parent visibility and trend reporting.",
  },
  {
    icon: MessageSquare,
    title: "Parent Communication",
    description: "Send announcements, updates, and reminders without leaving the platform.",
  },
  {
    icon: BadgeDollarSign,
    title: "Fees and Finance",
    description: "Track balances, receipts, and payment activity with clear reporting.",
  },
  {
    icon: ShieldCheck,
    title: "Operational Control",
    description: "One system for attendance, academics, messaging, and school records.",
  },
];
...
const testimonials = [
  {
    ...
    role: "Headteacher",
    quote: "Attendance, reports, and communication now take minutes instead of hours.",
  },
  {
    name: "Mrs. Grace Tembo",
    role: "Deputy Principal",
    quote: "Parent visibility improved immediately once everything moved into one system.",
  },
  {
    name: "Mr. Chanda Mutale",
    role: "Administrator",
    quote: "Finance tracking is clearer, faster, and easier for the whole school office.",
  },
];
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/92 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-sky-600">ZamSchool</p>
      ...
      <main>
          ...
          <div className="relative mx-auto grid min-h-[calc(100vh-81px)] max-w-7xl items-center gap-14 px-6 py-20 lg:grid-cols-[1.15fr_0.85fr]">
            <div>
              ...
              <h1 className="mt-8 max-w-4xl text-5xl font-extrabold tracking-tight text-white md:text-6xl xl:text-7xl">
                The smart school operating system for faster, calmer school operations.
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
                Manage students, teachers, attendance, parent communication, exams, and finance from one platform that loads fast and stays focused on the work schools do every day.
              </p>

              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  href="/register"
                  className="inline-flex items-center gap-2 rounded-full bg-sky-500 px-7 py-4 text-base font-bold text-white transition hover:bg-sky-400"
                >
                  Get Started Free
                ...
                <Link
                  href="/login"
                  className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-7 py-4 text-base font-semibold text-white transition hover:bg-white/15"
                >
                  Explore Platform
                </Link>
              </div>
            ...
            >
              ...
              <div className="mt-6 grid gap-4">
                <div className="flex items-center justify-between rounded-2xl bg-slate-900 px-5 py-4 text-white">
                  <div>
                    <p className="text-xs uppercase tracking-[0.22em] text-sky-200">Admin Dashboard</p>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-2xl bg-sky-50 p-4">
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-sky-700">Students</p>
                    <p className="mt-2 text-3xl font-bold text-slate-900">1,248</p>
                    <p className="mt-1 text-sm text-slate-600">Across classes, exam groups, and attendance streams.</p>
                  </div>
                  <div className="rounded-2xl bg-violet-50 p-4">
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-violet-700">Teachers</p>
                    <p className="mt-2 text-3xl font-bold text-slate-900">64</p>
                    <p className="mt-1 text-sm text-slate-600">Assignments, timetables, and role-based access in one place.</p>
                  </div>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 p-5">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-semibold text-slate-900">This week at a glance</p>
                      <p className="text-sm text-slate-500">Attendance, announcements, and fees in one surface.</p>
                    </div>
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-3">
                    <div className="rounded-xl bg-slate-50 p-3">
                      ...
                      <p className="mt-2 text-xl font-bold text-slate-900">Mon-Fri</p>
                      <p className="mt-1 text-sm text-slate-600">Live updates for present and absent learners.</p>
                    </div>
                    <div className="rounded-xl bg-slate-50 p-3">
                      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Announcements</p>
                      <p className="mt-2 text-xl font-bold text-slate-900">3 active</p>
                      <p className="mt-1 text-sm text-slate-600">Exams, sports day, and fee deadline notices.</p>
                    </div>
                    <div className="rounded-xl bg-slate-50 p-3">
                      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Collections</p>
                      <p className="mt-2 text-xl font-bold text-slate-900">K 482k</p>
                      <p className="mt-1 text-sm text-slate-600">Payment tracking with clearer follow-up.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section id="features" className="mx-auto max-w-7xl px-6 py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              ZamSchool OS combines the day-to-day systems schools already need, then keeps them close enough that staff can move quickly instead of bouncing between spreadsheets and disconnected tools.
            </p>
          </div>
        ...
        <section id="solutions" className="bg-slate-950 py-24 text-white">
          <div className="mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-sky-300">Solutions</p>
            ...
            <div className="grid gap-5 md:grid-cols-3">
              <article className="rounded-3xl border border-white/10 bg-white/5 p-6">
                ...
                <p className="mt-3 text-sm leading-7 text-slate-300">
                  Keep attendance, reporting, user management, and school communication in one workflow.
                </p>
              </article>
              <article className="rounded-3xl border border-white/10 bg-white/5 p-6">
                <h3 className="text-xl font-bold">Teachers</h3>
                <p className="mt-3 text-sm leading-7 text-slate-300">
                  Mark attendance quickly, review results, and message guardians without switching tools.
                </p>
              </article>
              <article className="rounded-3xl border border-white/10 bg-white/5 p-6">
                <h3 className="text-xl font-bold">Parents</h3>
                <p className="mt-3 text-sm leading-7 text-slate-300">
                  Stay informed about attendance, announcements, and fee reminders from any device.
                </p>
              </article>
            </div>
          </div>
        ...
        <section id="pricing" className="bg-slate-50 py-24">
          <div className="mx-auto max-w-5xl px-6">
            <div className="text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-amber-600">Pricing</p>
              <h2 className="mt-4 text-4xl font-extrabold tracking-tight text-slate-900 md:text-5xl">
            ...
            <div className="mt-14 rounded-[2rem] border border-sky-200 bg-white p-8 shadow-xl shadow-sky-100/70">
              <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  <p className="text-sm font-semibold uppercase tracking-[0.2em] text-sky-600">Starter</p>
                  <h3 className="mt-3 text-4xl font-extrabold text-slate-900">Free 14-day trial</h3>
                  <p className="mt-4 max-w-2xl text-base leading-8 text-slate-600">
                    Full platform access for onboarding, attendance, communication, results, and finance workflows.
                  </p>
                </div>
                <Link
                  href="/register"
        ...
        <section className="mx-auto max-w-7xl px-6 py-24">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-[0.24em] text-violet-600">Trusted by schools</p>
            <h2 className="mt-4 text-4xl font-extrabold tracking-tight text-slate-900 md:text-5xl">
        ...
        <section id="about" className="bg-slate-950 py-24 text-white">
          <div className="mx-auto max-w-5xl px-6 text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-300">
              Register your school in minutes and give every student, teacher, and parent a platform that is easier to use and faster to trust.
            </p>
