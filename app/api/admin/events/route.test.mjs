...
const routePath = resolve(process.cwd(), "app", "api", "admin", "events", "route.ts");

test("admin events route normalizes target roles separately from legacy audience values", async () => {
