...
const routePath = resolve(process.cwd(), "app", "api", "teacher", "results", "route.ts");

test("teacher results route uses teacher auth and assignment scope", async () => {
  ...
  assert.match(source, /actorTeacherIds/);
